...
def test_derive_state_progresses_with_artifacts():
    ...
    arts.append(_ref(ArtifactType.APPROVAL, sv.artifact_id, actor="alice",
                     actor_kind=ActorKind.HUMAN, payload={"verdict": "approve"}))
    assert derive_state(sv.artifact_id, arts) == SkillState.APPROVED
    arts.append(_ref(ArtifactType.APPROVAL, sv.artifact_id, actor="alice", actor_kind=ActorKind.HUMAN,
...
def test_rejected_approval_does_not_publish():
    ...
    arts = [sv,
            ...
            _ref(ArtifactType.APPROVAL, sv.artifact_id, actor="alice", actor_kind=ActorKind.HUMAN,
